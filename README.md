...
|---|--------|------|----------|-----|-----|----------|-----------|--------|-------|-------|-------|
| 1 | **NICFC** | NIC Asia Flexi Cap F | -8.18% | 10.02 | 9.20 | 3.3y | medium | 6d | 3.51% | 66.3 | → |
| 2 | **PSF** | Prabhu Select Fund | -6.90% | 12.03 | 11.20 | 2.3y | medium | 1d | 3.35% | 64.3 | ↑ |
| 3 | **SFMF** | Sunrise First Mutual | -9.20% | 11.30 | 10.26 | 3.7y | medium | 3d | -2.04% | 60.8 | ↓ |
| 4 | **NBF2** | Nabil Balanced Fund  | -7.68% | 10.42 | 9.62 | 3.3y | medium | 6d | 2.26% | 55.5 | ↓ |
| 5 | **NICSF** | NIC Asia Select-30 | -4.40% | 9.54 | 9.12 | 2.4y | medium | 5d | — | 52.3 | ↑ |

### Top Picks by Composite Score

- **NICFC** (NIC Asia Flexi Cap Fund): -8.18% discount, score 66.3
- **PSF** (Prabhu Select Fund): -6.90% discount, score 64.3
- **SFMF** (Sunrise First Mutual Fund): -9.20% discount, score 60.8
...
- Latest price data: 2026-02-17
- NAV data age: median 34 days
- History depth: 6 trading day(s)
